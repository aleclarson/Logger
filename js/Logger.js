...
var Event, Formatter, Line, Promise, Type, assertType, cloneObject, concatArgs, emptyFunction, isNodeJS, sliceArray, stripAnsi, type;
...
type.defineMethods({
  ...
  onceFlushed: function(callback) {
    if (this._flushing !== null) {
      return this.didFlush.once(callback);
    } else {
      return Promise["try"](callback);
    }
  },
  _log: function() {
    if (this.isQuiet || !arguments.length) {
      return false;
    }
    return this._logArgs(sliceArray(arguments));
  },
