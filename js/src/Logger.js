...
var Event, Formatter, Line, Logger, Type, Void, assert, assertType, concatArgs, emptyFunction, ref, repeatString, stripAnsi, sync, type;
...
type.optionTypes = {
  print: Function,
  process: isNodeJS ? [Object.Kind, Void] : Void
};
...
if (isNodeJS) {
  type.initInstance(function(options) {
    ...
    if (this.process.stdout) {
      return this._print = (function(_this) {
